...
Tree cover is **significantly higher in the urban forest** than the urban center (z = -14.50, df = 1, 21, p < 0.001). The means and SE's are 47.15 ± 2.17 % for the urban forest and 1.58 ± 0.36 % for the urban center. 
...
Impervious cover is **significantly higher in the urban center** than the urban forest (z = 14.51, df = 1, 21, p < 0.001). The means and SE's are 1.27 ± 0.36 % for the urban forest and 76.52 ± 2.53 % for the urban center. 
...
**Road disturbance is higher in the urban center** than the urban forest (z = 39.19, df = 1, 21, p < 0.001). The means and SE's are 104 ± 3.23 vehicles/day/m for the urban forest and 398 ± 5.76 vehicles/day/m for the urban center. 
...
**Highway disturbance is higher in the urban center** than the urban fores (z = 9.388, df = 1, 21, p < 0.001). The means and SE's are 35.6 ± 1.89 vehicles/day/m for the urban forest and 65.0 ± 2.33 vehicles/day/m for the urban center. 
...
Plant species richness is **significantly higher in the urban forest** than the urban center (z = -7.674, df = 1, 21, p < 0.001). The means and SE's are 13.30 ± 1.153 species for the urban forest and 3.33 ± 0.527 species for the urban center. 
...
Spectral radiance is **significantly higher in the urban center** than the urban forest (z = 3.079, df = 1, 21, p = 0.002). The means and SE's are 137.44 ± 3.71 Watts/(m² * sr * µm) for the urban forest and 153.39 ± 3.58 Watts/(m² * sr * µm) for the urban center. 
...
Light radiance is **significantly higher in the urban center** than the urban forest (z = 22.46, df = 1, 21, p < 0.001). The means and SE's are 5.89 ± 0.77 mcd/m² for the urban forest and 116.90 ± 3.12 mcd/m² for the urban center.
...
Patch area is **significantly higher in the urban forest** than the urban center (z = -374.2, df = 1, 21, p < 0.001). The means and SE's are 46,294.7 ± 68.040 mm² for the urban forest and 653.8 ± 7.381 mm² for the urban center. 
...
Total road length is **significantly higher in the urban center** than the urban forest (z = 20.89, df = 1, 21, p < 0.001). The means and SE's are 15.67 ± 1.25 m for the urban forest and 93.03 ± 2.78 m for the urban center. 
...
#  annotate(geom = "text", x = min(predicted.distance$log_TotalSub) + diff(range(predicted.distance$log_TotalSub))/2, y = max(log(sites$NumSpiders)), label = "***", color = "black", size = 4)
    annotate(geom = "text", x = min(predicted.distance$log_TotalSub) + diff(range(predicted.distance$log_TotalSub))/2, y = 3, label = "***", color = "black", size = 4)
...
#  annotate(geom = "text", x = min((predicted.distance$log_tdh)) + diff(range((predicted.distance$log_tdh)))/2, y = max(log(sites$NumSpiders)), label = "***", color = "black", size = 4)
  annotate(geom = "text", x = min((predicted.distance$log_tdh)) + diff(range((predicted.distance$log_tdh)))/2, y = 3, label = "***", color = "black", size = 4)
...
#  annotate(geom = "text", x = min((predicted.distance$log_tdh)) + diff(range((predicted.distance$log_tdh)))/2, y = max(log(sites_center$NumSpiders)), label = "***", color = "black", size = 4) 
  annotate(geom = "text", x = min((predicted.distance$log_tdh)) + diff(range((predicted.distance$log_tdh)))/2, y = 3.5, label = "***", color = "black", size = 4) 
...
#  annotate(geom = "text", x = min(predicted.distance$log_TotalSub) + diff(range(predicted.distance$log_TotalSub))/2, y = max(log(near$RetreatDist)), label = "***", color = "black", size = 4)
  annotate(geom = "text", x = min(predicted.distance$log_TotalSub) + diff(range(predicted.distance$log_TotalSub))/2, y = 6.8, label = "***", color = "black", size = 4)
...
#  annotate(geom = "text", x = min((predicted.distance$road_length_m)) + diff(range((predicted.distance$road_length_m)))/2, y = max(log(near_center$RetreatDist)), label = "***", color = "black", size = 4)
  annotate(geom = "text", x = min((predicted.distance$road_length_m)) + diff(range((predicted.distance$road_length_m)))/2, y = 7, label = "***", color = "black", size = 4)
...
#  annotate(geom = "text", x = min(predictions$log_tdr) + diff(range(predictions$log_tdr))/2, y = max(log(webs$RetreatHeight)), label = "N. S.", color = "black", size = 4)
    annotate(geom = "text", x = min(predictions$log_tdr) + diff(range(predictions$log_tdr))/2, y = 5.8, label = "N. S.", color = "black", size = 4)
...
mean_se1 <- c("Mean ± Std. Error", "Urban Forest \n(Wilderness Park)", "47.15 ± 2.17", "1.27 ± 0.36", "137.44 ± 3.71", "5.89 ± 0.77", "13.30 ± 1.15", "46,294.7 ± 68.040", "104 ± 3.23", "35.6 ± 1.89", "15.67 ± 1.25")
mean_se2 <- c("Mean ± Std. Error", "Urban Center \n(UNL City Campus)", "1.58 ± 0.36", "76.52 ± 2.53", "153.39 ± 3.58", "116.90 ± 3.12", "3.33 ± 0.53", "116.90 ± 3.12", "398 ± 5.76", "65.0 ± 2.33", "93.03 ± 2.78")
