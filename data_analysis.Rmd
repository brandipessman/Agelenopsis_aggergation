...
main_row1 <- ggarrange(nb_plot_search, nb_plot_webs, nb_plot_spiders, labels = c("a", "b", "c"), nrow = 1, font.label = list(size = 10))
main_row2 <- ggarrange(nb_plot_dist, nb_plot_height, blankPlot, labels = c("d", "e", ""), nrow = 1, font.label = list(size = 10))
...
Chi <- c(6.37, 19.134, 10.913, 40.757, 12.569)
df <- c("4, 21", "4, 21", "4, 21", "4, 20", "4, 130")
P <- c("  0.173", "< 0.001 ***", "  0.028 *", "< 0.001 ***", "  0.014 *")
